...
- Shin, M. (2026). *mathipy: Multimodal item feature extraction for K-12 math assessment* (Python package version 0.4.5) [Computer software]. <https://github.com/mshin77/mathipy>
